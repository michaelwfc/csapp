...
int main(int argc, char **argv)
{
    ...
    {
        ready_set = read_set;
        // The Select function in your code will block until at least one of the file descriptors in the ready_set 
        // becomes ready for the specified operation (reading, writing, or having an exception condition).
