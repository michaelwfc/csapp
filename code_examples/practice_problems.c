...
%rax    0x100       Register
0x104   0xAB        Absolute  memory reference
$0x108  0x108       Immediate operand

(%rax)  0xFF        Indirect memory reference
4(%rax)        4+0x100=0x104                      -> 0xAB  Displacement + Base  memory reference
9(%rax,%rdx)   9+0x100+ 0x3=0x10C                 -> 0x11   Indexed  memory reference
260(%rcx,%rdx) 260+0x1+ 0x3=0x104 +0x1+0x3=0x108  -> 0x13
