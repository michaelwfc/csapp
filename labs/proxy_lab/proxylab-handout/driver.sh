...
# Second Fetch (test the cache)
# It uses curl again to fetch home.html through the proxy.
# Since Tiny is gone, this request can only succeed if your proxy cached it.
